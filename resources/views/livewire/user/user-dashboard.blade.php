        ...
        <style>
            ...
            * {
            ...
            .card .icon-bg {
                ...
                /* Smooth transition for movement, size, and position */
            }
            ...
            .table-header {
                display: flex;
                justify-content: space-between;
                /* Space between the header and the "See All" */
                align-items: center;
                /* Align them vertically in the middle */
                margin-bottom: 15px;
            }
            ...
            .table-section {
                ...
                background: #fff;
                border-radius: 10px;
                box-shadow: 0 2px 5px rgba(176, 41, 41, 0.1);
            }
        ...
        <section class="home-section">
            ...
            <div class="cards">
                <div class="card orange">
                    <h2>77</h2>
                    <p>Reported lost</p>
                    <i class="bx bx-tag icon-bg"></i>
                    <a href="{{ route('ilost') }}">Show all items <i class="bx bx-arrow-right"></i></a>
                </div>
                <div class="card blue">
                    <h2>30</h2>
                    <p>Items found</p>
                    <i class="bx bx-tag icon-bg"></i>
                    <a href="{{ route('ifound') }}">Show all items <i class="bx bx-arrow-right"></i></a>
                </div>
                <div class="card teal">
                    <h2>0</h2>
                    <p>Items matched</p>
                    <i class="bx bx-check icon-bg"></i>
                    <a href="{{ route('imatched') }}">Show all items <i class="bx bx-arrow-right"></i></a>
                </div>
                <div class="card green">
                    <h2>0</h2>
                    <p>Successfully returned</p>
                    <i class="bx bx-undo icon-bg"></i>
                    <a href="{{ route('ireturned') }}">Show all items <i class="bx bx-arrow-right"></i></a>
                </div>
            </div>
            <div class="table-section">
                <div class="table-header">
                    <h2>Recent Lost</h2>
                    <a href="{{ route('ilost') }}" class="see-all">See All</a>
                </div>
                <table>
                    <thead>
                        <tr>
            ...
            <!-- Recent Found Section  -->
            <div class="table-section">
                <div class="table-header">
                    <h2>Recent Found</h2>
                    <a href="{{ route('ifound') }}" class="see-all">See All</a>
                </div>
                    <table>
                        <thead>
                            <tr>
                ...
                <!-- Recent Matched Section  -->
            <div class="table-section">
                <div class="table-header">
                    <h2>Recent Matched</h2>
                    <a href="{{ route('imatched') }}" class="see-all">See All</a>
                </div>
                    <table>
                        <thead>
                            <tr>
                ...
                <!-- Recent Returned Section  -->
            <div class="table-section">
                <div class="table-header">
                    <h2>Recent Returned</h2>
                    <a href="{{ route('ireturned') }}" class="see-all">See All</a>
                </div>
                    <table>
                        <thead>
                            <tr>
